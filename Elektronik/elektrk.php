...
<head>
    ...
    <link rel="stylesheet" href="elektrk.css">
    <script src="elektrk.js" defer></script>
...
<nav>
    <ul class="two">
        <li><a href="../Elektronik/elektrk.php"class="elek">Elektronik</a></li>
...
<section class="menu">
    <div class="box-container">
        <div class="box"><a href="../urun/urun.php" target="_blank" ><img src="Resimler/box1.jpg" alt="" ></a></div>
        <div class="box"><a href="../urun/urun.php" target="_blank" ><img src="Resimler/box1.jpg" alt="" ></a></div>
        <div class="box"><a href="../urun/urun.php" target="_blank" ><img src="Resimler/box1.jpg" alt="" ></a></div>
        <div class="box"><a href="../urun/urun.php" target="_blank" ><img src="Resimler/box1.jpg" alt="" ></a></div>
        <div class="box"><a href="../urun/urun.php" target="_blank" ><img src="Resimler/box1.jpg" alt="" ></a></div>
