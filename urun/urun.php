...
<ul class="two">
    ...
    <li><a href="../giyim/giyim.php"class="elek">Giyim</a></li>
...
<div class="cerceve">
    <div class="galeri">
       <img src="../Resimler/1.jpg">
        <img src="../Resimler/2.jpg">
...
<form action="" class="sepetform">
    ...
    <input type="text" name="fiyat" placeholder="Fiyat" id="urun_fiyat" disabled >
    <input type="text" name="adet" placeholder="Adet giriniz"pattern="\d"><br>
    <input class="urunacikla" type="text" name="urun_aciklama" placeholder="Ürün Açıklaması" id="urun_aciklama" disabled >
    <button type="submit" class="sepetbtn">Sepete Ekle</button>
</form>
</div>
